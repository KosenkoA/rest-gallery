package com.restconsumer.services.impl;

import com.restconsumer.dtos.PictureDto;
import com.restconsumer.helpers.RequestHelper;
import com.restconsumer.helpers.SearchHelper;
import com.restconsumer.models.Item;
import com.restconsumer.repositories.ItemRepository;
...
public class PictureServiceImpl implements PictureService {
    ...
    public List<PictureDto> getAll() {
        return itemRepository.findAll().stream()
                .map(item -> new PictureDto(item.getId(), item.getCropped_picture()))
    ...
    public List searchItems(String searchTerm) {
        return itemRepository.findAll(SearchHelper.containsText(searchTerm));
    }
}
